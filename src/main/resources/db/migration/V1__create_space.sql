...
INSERT INTO customer(id, name, created, change, email, address, city, country, phone)
...
VALUES ('e007d126-3e5b-11ee-be56-0242ac120002', 'Sibneft', '1900-01-01', '1900-01-01', 'mail@mail.com', 'Adr', 'Moscow',
        'Russia', '9423532');
INSERT INTO application(id, "number", creator, owner, type, description, created, change, price, phone,
